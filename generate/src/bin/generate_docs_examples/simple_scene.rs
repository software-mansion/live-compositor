...
pub(super) fn generate_simple_scene_guide() -> Result<()> {
    generate_scene("simple_scene_1.webp", json!({
        "type": "view",
        "background_color_rgba": "#4d4d4dff",
    }))?;
    generate_scene("simple_scene_2.webp", json!({
        "type": "view",
        "background_color_rgba": "#4d4d4dff",
        "children": [
    ...
    generate_scene("simple_scene_3.webp", json!({
        "type": "view",
        "background_color_rgba": "#4d4d4dff",
        "children": [
            {
    ...
    generate_scene("simple_scene_4.webp", json!({
        "type": "view",
        "background_color_rgba": "#4d4d4dff",
        "children": [
            {
    ...
    generate_scene("simple_scene_5.webp", json!({
        "type": "view",
        "background_color_rgba": "#4d4d4dff",
        "children": [
            {

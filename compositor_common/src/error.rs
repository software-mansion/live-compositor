...
use crate::scene::{builtin_transformations::GRID_MAX_INPUTS_COUNT, NodeId, OutputId};
...
pub enum BuiltinSpecValidationError {
    ...
    #[error(
        "Nodes that use transformation \"grid\" need to have at most {GRID_MAX_INPUTS_COUNT}."
    )]
    GridTooManyInputs,

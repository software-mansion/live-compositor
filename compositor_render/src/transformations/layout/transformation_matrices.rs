...
impl Layout {
    ...
    pub(super) fn transform_vertices_matrix(&self, output_resolution: &Resolution) -> Mat4 {
        ...
        /// coordinate system
        fn translation_to_final_position(layout: &Layout, output_resolution: &Resolution) -> Vec3 {
    ...
    pub(super) fn transform_texture_coords_matrix(&self, input_resolution: &Resolution) -> Mat4 {
        match self.content {
            super::LayoutContent::Color(_) | super::LayoutContent::None => Mat4::identity(),
            super::LayoutContent::ChildNode { ref crop, .. } => {

...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    switch layout_info.layout_type {
        case 0u: {
            ...
            let content_alpha = smoothstep(border_width - 1.0, border_width + 1.0, edge_distance) * mask_alpha;
            let border_alpha = smoothstep(-border_width - 1.0, -border_width + 1.0, -edge_distance) * smoothstep(-1.0, 1.0, edge_distance) * mask_alpha;

...
@group(1) @binding(0) var<uniform> layout_transformation_matrices: array<mat4x4<f32>, 16>;
...
fn vs_main(input: VertexInput) -> VertexOutput {
    ...
    let transformation_matrix: mat4x4<f32> = layout_transformation_matrices[input.texture_id];

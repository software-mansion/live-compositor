...
use video_compositor::types::{
    Image, InputStream, RegisterInputRequest, Rescaler, ShaderSpec, Text, Tiles, View,
    WebRendererSpec, WebView,
};
...
fn main() {
    ...
    let renderer_pages = [
        ...
        generate_docs::<RegisterInputRequest>("RegisterInputRequest"),
    ];

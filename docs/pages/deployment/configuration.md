...
If enabled, sets `SMELTER_AHEAD_OF_TIME_PROCESSING_ENABLE` and `SMELTER_NEVER_DROP_OUTPUT_FRAMES` options to `true`. If those values are also defined then they take priority over this value.
